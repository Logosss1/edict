...
The desktop migration workspace omits video, GIF, and screenshot media. Run the build commands in `desktop/` to exercise the full dashboard.
...
Screenshot media is omitted from the desktop migration workspace. Feature and verification records live under `specs/` at the project root.
